...
async function fetchSheetData() {
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbx61eAAm55S2jPQNdSLM1IcEaIYAS3sRX3Jywxt-6buwKqBbtFyl4wtOVSCJTtqTPs/exec');
...
function openGoogleSheet() {
    window.open('https://docs.google.com/spreadsheets/d/1oStg0xK7kiJzlD2mdKOTT9oCSUaEs0bcfN8wEhUkaQo/edit?gid=0#gid=0', '_blank');
}
